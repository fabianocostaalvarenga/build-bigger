...
behavior of the Gradle build tool, allowing automation of repetitive com.udacity.gradle.builditbigger.tasks.
...
Start or stop your local server by using the gradle com.udacity.gradle.builditbigger.tasks as shown in the following
screenshot:

<img src="/FinalProject/GCE-server-gradle-com.udacity.gradle.builditbigger.tasks.png" height="500">
...
For extra practice to make your project stand out, complete the following com.udacity.gradle.builditbigger.tasks.
